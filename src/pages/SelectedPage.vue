<template>
  <div class="selected-Page container-fluid">
   ...
   <div class="col-md-6">
    <img src="//thiscatdoesnotexist.com" alt="" class="img-fluid rounded elevation-4">
   </div>

   <div class="col-md-6">
<div>
  <div class="card   elevation-3 mx-4 my-2 " style="width:22rem;">
             <div class="d-flex justify-content-center">
               <img src="https://d2ph5fj80uercy.cloudfront.net/04/cat3676.jpg" alt=""
